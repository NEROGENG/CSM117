        ...
        if (pid != 0){                                              //mouse
            ...
            //new CountDownTimer(30000, 1000){
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    ParseQuery<ParseObject> query2 = ParseQuery.getQuery("PlayerInfo");
                    query2.whereEqualTo("pid", String.valueOf(0));          //check that the cat has raged
                    try{
                        if(query2.count() == 1){
                            ParseObject obj = query2.getFirst();
                            if(obj.getBoolean("isAlive")){
                                if (!Ended ) {
                    ...
                    if (Ended){
                        txt2.setText("The Cat has left!  Click anywhere to continue!");
                    }
                    else
                ...
                public void onFinish() {
                    ...
                    txt2.setText("You win! Click anywhere to continue");
                    gameEnd(0);
